...
1. **If PRD.md is MISSING or EMPTY:**
   → Interview the user to create it:
...
- Work through 🤖 tasks sequentially without asking
- Skip 🧑 tasks (document them in HANDOFF.md)
...
This creates a tight feedback loop: implement → verify in browser → fix issues → commit.
...
- "Implement user authentication" → Break into: form, API, validation, session, tests
- "Build the dashboard" → Break into: layout, widgets, data fetching, etc.
