	...
	>
		...
		<div class="flex-1 overflow-y-auto p-6">
			<div class="space-y-6">
					...
					{#if selectedExercise}
						<div class="bg-gray-50 rounded-lg p-4 mb-4">
							...
							<div class="grid grid-cols-3 gap-4 mb-4">
								<div>
									<label for="target-sets" class="block text-sm font-medium text-gray-700 mb-1">
										Sets
									</label>
									<input
										id="target-sets"
								...
								<div>
									<label for="target-reps" class="block text-sm font-medium text-gray-700 mb-1">
										Reps
									</label>
									<input
										id="target-reps"
								...
								<div>
									<label for="target-weight" class="block text-sm font-medium text-gray-700 mb-1">
										Weight (lbs)
									</label>
									<input
										id="target-weight"
				...
				<div>
					<label for="workout-notes" class="block text-sm font-medium text-gray-700 mb-1">
						Notes (optional)
					</label>
					<textarea
						id="workout-notes"
		...
		<div class="p-6 border-t border-gray-200 bg-gray-50">
			<div class="flex gap-3">
				<button
					...
					type="button"
					class="flex-1 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
				>
					Preview
				</button>
				<button
					onclick={onClose}
					type="button"
					class="flex-1 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-white transition-colors"
				>
					Cancel
				</button>
				<button
