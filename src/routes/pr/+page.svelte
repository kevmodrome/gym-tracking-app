	...
	<div class="max-w-7xl mx-auto">
		<div class="flex items-center justify-between mb-6">
			<div class="flex items-center gap-4">
				...
				<h1 class="text-3xl font-bold text-gray-900">Personal Records</h1>
			</div>
			<button
		...
		{#if allPRs.length === 0}
			<div class="bg-white rounded-lg shadow-md p-12 text-center">
				...
				<h2 class="text-2xl font-bold text-gray-900 mb-2">No Personal Records Yet</h2>
			...
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
				{#each groupedPRs as group}
					<div class="bg-white rounded-lg shadow-md p-6">
						<h2 class="text-xl font-bold text-gray-900 mb-4">{group.exerciseName}</h2>
						<div class="space-y-3">
									...
									<div class="flex items-center gap-3">
										...
										<div>
											...
											<p class="text-sm text-gray-500">
												Achieved: {new Date(pr.achievedDate).toLocaleDateString()}
											</p>
										</div>
									</div>
									<button
	...
	<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
		<div class="bg-white rounded-lg shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
			<div class="p-6">
				...
				{:else}
					<p class="text-gray-500 text-center py-8">No history available for this rep range</p>
				{/if}
