...
# Copy scripts
cp "$SKILL_DIR/scripts/"*.sh .opencode/ralph-scripts/ 2>/dev/null || true
chmod +x .opencode/ralph-scripts/*.sh 2>/dev/null || true
...
echo "     (or: .opencode/ralph-scripts/ralph-loop.sh)"
echo ""
